				...
				<div class="row">
					...
					<div class="col-md-4" align="center">
						<div class="card" style="width: 18rem; text-align: center;">
                            <img src="img/Corte_de_vinil.png" class="card-img-top" alt="...">
                            <div class="card-body">
                              <h5 class="card-title">Corte de Vinil</h5>
                              <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                              <a href="javascript:place(7)" class="btn btn-primary">Añadir al carrito</a>
                            </div>
                        </div>
                        <br>
					</div>
					<div class="col-md-4" align="center">
						<div class="card" style="width: 18rem; text-align: center;">
                            <img src="img/lona.png" class="card-img-top" alt="...">
                            <div class="card-body">
                              <h5 class="card-title">Lonas</h5>
                              <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                              <a href="javascript:place(8)" class="btn btn-primary">Añadir al carrito</a>
                            </div>
                        </div>
                        <br>
					</div>
					<div class="col-md-4" align="center">
						<div class="card" style="width: 18rem; text-align: center;">
                            <img src="img/lamina.png" class="card-img-top" alt="...">
                            <div class="card-body">
                              <h5 class="card-title">Láminas</h5>
                              <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                              <a href="javascript:place(9)" class="btn btn-primary">Añadir al carrito</a>
                            </div>
                        </div>
                        <br>
					</div>
