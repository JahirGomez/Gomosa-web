		...
		<div class="row">
			<div class="container-fluid">
				<section class="form-registro">
                    <h5>Favor de rellenar los siguientes campos</h5>
                    <input class="controls" type="text" name="contrasena" value="" placeholder="Nombre(s)">
                    <input class="controls" type="text" name="contrasena" value="" placeholder="Apelldos">
                    <input class="controls" type="text" name="contrasena" value="" placeholder="Teléfono">
                    <input class="controls" type="text" name="contrasena" value="" placeholder="Correo">
                    <input class="controls" type="text" name="usuario" value="" placeholder="Usuario">
                    <input class="controls" type="password" name="contrasena" value="" placeholder="Contraseña">
                    <input class="controls" type="password" name="contrasena" value="" placeholder="Confirme su contraseña">
                    <input class="buttons" type="submit" name="" value="Ingresar">
                    <p><a href="iniciarSesion.html">¿Ya tiene una cuenta? Inicie sesión</a></p>
                  </section>
			</div>
		</div>
		<br>
