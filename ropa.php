		...
		<div class="row">
			<div class="col-md-12">
				<ul class="nav nav-pills">
					...
					<li class="nav-item">
						<a class="nav-link active" href="ropa.html">Ropa</a>
					</li>
					<li class="nav-item">
				...
				<div class="row">
					...
					<div class="col-md-4" align="center">
						<div class="card" style="width: 18rem; text-align: center;">
                            <img src="img/gorras.png" class="card-img-top" alt="...">
                            <div class="card-body">
                              <h5 class="card-title">Gorras</h5>
                              <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                              <a href="javascript:place(1)" class="btn btn-primary">Añadir al carrito</a>
                            </div>
                        </div>
                        <br>
					</div>
					<div class="col-md-4" align="center">
						<div class="card" style="width: 18rem; text-align: center;">
                            <img src="img/guayaberas.png" class="card-img-top" alt="...">
                            <div class="card-body">
                              <h5 class="card-title">Guayaberas</h5>
                              <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                              <a href="javascript:place(2)" class="btn btn-primary">Añadir al carrito</a>
                            </div>
                        </div>
                        <br>
					</div>
					<div class="col-md-4" align="center">
						<div class="card" style="width: 18rem; text-align: center;">
                            <img src="img/batas.png" class="card-img-top" alt="...">
                            <div class="card-body">
                              <h5 class="card-title">Batas</h5>
                              <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                              <a href="javascript:place(3)" class="btn btn-primary">Añadir al carrito</a>
                            </div>
                        </div>
                        <br>
					</div>
